            ...
            using (var reader = command.ExecuteReader())
            {
                while (await reader.ReadAsync())
                {
                    var sd= new SchoolDetails
                    {
                        ...
                        Discount_Percent = reader.GetInt32(reader.GetOrdinal("Discount_Percent")),
                        Discounted_Price = reader.GetDecimal(reader.GetOrdinal("Discounted_Price"))
                     };
